...
const ProductDetail = () => {
  ...
  return (
    <MainContainer header={{title: product.product, noLeft: true,backgroundColor:Colors.header}}>
     <View style={styles.containerTop}>
        ...
        {!product.is_redemption ?  <Text style={styles.labelT}>Con esta compra acumulaste:</Text>:
          ...
          <View style={{flexDirection: 'row', marginTop: 20,flex:1}}>
            <Button  style={[styles.btn]} title="Aceptar" onPress={()=>goBack()} />
          </View>
          </View>
